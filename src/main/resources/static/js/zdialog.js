...
(function ($, window, document, undefined) {
    //默认参数
    var PARAMS;
    var DEFAULTPARAMS = {Title: "信息", Content: "", BtnL: "确定", BtnR: "取消", FunL: {}, FunR: {}};
    $.DialogMessage = {
        //弹出提示框
...
function alertMessage(content) {
    ...
    $.DialogMessage.Alert(params);
}

//弹出确认框简化
function confirmMessage(content, confirmFun) {
    var params = {
        Title: "提示",
        Content: content,
        BtnL: "确定",
    ...
    $.DialogMessage.Confirm(params);
}

// 自动显示弹框简化
function autoFadeMessage(content) {
    var params = {Content: content};
    $.DialogMessage.AutoFade(params);
}